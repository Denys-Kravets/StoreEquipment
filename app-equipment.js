document.addEventListener('DOMContentLoaded', function() {
    ...
    equipmentItems.forEach(item => {
        item.addEventListener('click', function() {
            ...
            window.location.href = `product.html?image=${encodeURIComponent(imageSrc)}&name=${encodeURIComponent(itemName)}&description=${encodeURIComponent(itemDescription)}&price=${encodeURIComponent(itemPrice)}`;
        });
    });
});